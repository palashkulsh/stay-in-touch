...
import { View, Text, TextInput, TouchableOpacity, Modal, TouchableWithoutFeedback, Keyboard,StyleSheet } from 'react-native';

const RepeatDaysModal = ({ isVisible, setIsVisible, tempRepeatDays, setTempRepeatDays, updateRepeatDays, contactName }) => {
  return (
    <Modal
      animationType="slide"
      transparent={true}
